...
import 'package:mobx_studies_app/todo/todo.dart';
...
abstract class _TodoList with Store {
  ...
  String get itemsDescription {
    if (todos.isEmpty) {
      return "Nada aqui. Porque não adiciona um?";
    }
    final suffix = pendingTodos.length == 1 ? 'todo' : 'todos';
    return '${pendingTodos.length} pendentes $suffix, ${completedTodos.length} completos.';
  }

  @computed
  ObservableList<Todo> get visibreTodos {
    switch (filter) {
