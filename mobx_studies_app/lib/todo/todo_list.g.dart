...
mixin _$TodoList on _TodoList, Store {
  ...
  String get itemsDescription => (_$itemsDescriptionComputed ??=
      ...
      .value;
  Computed<ObservableList<Todo>>? _$visibreTodosComputed;

  @override
  ObservableList<Todo> get visibreTodos => (_$visibreTodosComputed ??=
          Computed<ObservableList<Todo>>(() => super.visibreTodos,
              name: '_TodoList.visibreTodos'))
      .value;
